...
ggplot(data = world_data) +
  ...
  #                      alpha = 0.6) +
  geom_point(data = subset(file957_map,Label>87), aes(x=Longitude, y=Latitude), color = "blue", size = 8, alpha = 0.25) +
  geom_text(data = subset(file957_map,Label>87) %>% mutate(Label2 = 10:1),aes(x=Longitude, y=Latitude,label = Label2), size = 3.5,fontface="bold") +
  xlab(" ") + ylab(" ") +
